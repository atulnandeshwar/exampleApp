    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin-vendors-update', $user->id) }}">
                        @csrf
                        @method('PATCH')
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="store-name" type="text" class="form-control @error('store_name') is-invalid @enderror" name="store_name" value="{{ old('store_name', $user->details->store_name ?? '') }}" required autocomplete="store_name" autofocus>
